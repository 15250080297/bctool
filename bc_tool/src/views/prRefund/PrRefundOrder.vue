...
<script>
  ...
  import PrRefundEdit from './PrRefundEdit.vue'
  import ApprovalStream from '@/components/ApprovalStream'

  export default {
    name: 'tab',
    components: {ActionBar,SCContent, SCTable, SCSearch, SCDateRange,PrRefundEdit,ApprovalStream},
    data() {
      return {
        gridOptions:{
          defaultColDef:{
    ...
    methods: {
      ...
      onRowDoubleClicked:function (event) {
        this.$store.dispatch('ShowPrOrderDetail', event.data).then(()=>{
      ...
      addData:function () {
        this.$store.dispatch('ShowPrOrderDetail').then(()=>{});
      },
      searchData:function () {
