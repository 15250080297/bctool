<template>
  <div class="edit-container">
    <SCModify id="storageTransferAddModify" :show="showAdd">
      <ActionBar slot="menu">
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="6">
                <el-form-item label="出库部门" prop="outBuId">
                  <el-select v-model="headerData.outBuId" filterable placeholder="请选择" @change="changeForm">
...
<script>
  ...
  import { addStorageTransfer } from '@/api/storage-transfer.js'
  ...
  export default {
    ...
    computed: {
      showAdd: function () {
        let val = this.$store.state.storageTransfer.showAdd
        return val
      }
    },
    methods: {
          ...
          this.$confirm('确定放弃添加?', '提示', {
            ...
            callback: (action, instance) => {
              if ('confirm' == action) {
                ...
                this.$store.dispatch('HideAddStorageTransferDetail').then(() => {})
                this.emptyList()
                this.headerData = {}
              }
            }
