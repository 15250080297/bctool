<template>
  <div class="tab-container">
    ...
    <ActionBar>
      ...
      <el-button class="action-item" type="primary" @click="importStorage">{{$t('button.impStorage')}}</el-button>
    ...
    <SCSearch id="searchForm" title="采购发票查询">
      <el-form :model="form">
        ...
        <el-form-item label="采购发票单号" :label-width="formLabelWidth">
...
<script>
  ...
  export default {
    name: 'tab',
    components: {ActionBar,SCContent, SCTable, SCSearch, SCDateRange,InvoiceAdd,InvoiceEdit,StorageImport,ApprovalStream},
    data() {
      return {
        gridOptions:{
          defaultColDef:{
